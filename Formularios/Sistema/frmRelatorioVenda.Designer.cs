namespace WinForm_Controle_De_Estoque.Formularios.Sistema
{
    partial class frmRelatorioVenda
    {
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource1.Value = this.tCCORCAMENTOBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "WinForm_Controle_De_Estoque.Formularios.Sistema.RelatorioVendas.rdlc";
            ...
            this.tCCORCAMENTOBindingSource.DataSource = this.dataSet_Dados_Do_Banco;
            // 
